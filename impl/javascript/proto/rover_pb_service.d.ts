...
type RoverGetQueuedMarkedTxs = {
  readonly methodName: string;
  readonly service: typeof Rover;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof rover_pb.MarkedTxsReq;
  readonly responseType: typeof rover_pb.QueuedMarkedTxsResponse;
};
...
export class Rover {
  ...
  static readonly GetQueuedMarkedTxs: RoverGetQueuedMarkedTxs;
}
...
export class RoverClient {
  ...
  getQueuedMarkedTxs(
    requestMessage: rover_pb.MarkedTxsReq,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: rover_pb.QueuedMarkedTxsResponse|null) => void
  ): UnaryResponse;
  getQueuedMarkedTxs(
    requestMessage: rover_pb.MarkedTxsReq,
    callback: (error: ServiceError|null, responseMessage: rover_pb.QueuedMarkedTxsResponse|null) => void
