...
/**
 * optional string ol_balance = 3;
 * @return {string}
 */
proto.bc.exchange.Message.prototype.getOlBalance = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.bc.exchange.Message} returns this
 */
proto.bc.exchange.Message.prototype.setOlBalance = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string emb_balance = 4;
 * @return {string}
 */
proto.bc.exchange.Message.prototype.getEmbBalance = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
