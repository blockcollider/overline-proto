...
var Rover = (function () {
  function Rover() {}
  Rover.serviceName = "bc.rover.Rover";
  return Rover;
}());
...
RoverClient.prototype.getQueuedMarkedTxs = function getQueuedMarkedTxs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Rover.GetQueuedMarkedTxs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
