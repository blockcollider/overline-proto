...
export class RoverMessage extends jspb.Message {
  ...
  getLatestBlock(): RoverMessage.LatestBlock | undefined;
  setLatestBlock(value?: RoverMessage.LatestBlock): void;
...
export namespace RoverMessage {
  export type AsObject = {
    ...
    latestBlock?: RoverMessage.LatestBlock.AsObject,
  }
  ...
  export class LatestBlock extends jspb.Message {
    getRoverName(): string;
    setRoverName(value: string): void;
    ...
    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): LatestBlock.AsObject;
    static toObject(includeInstance: boolean, msg: LatestBlock): LatestBlock.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: LatestBlock, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): LatestBlock;
    static deserializeBinaryFromReader(message: LatestBlock, reader: jspb.BinaryReader): LatestBlock;
  }

  export namespace LatestBlock {
    export type AsObject = {
      roverName: string,
...
export class MarkedTxsReq extends jspb.Message {
  clearMarkedTransactionsList(): void;
  getMarkedTransactionsList(): Array<core_pb.MarkedTransaction>;
  setMarkedTransactionsList(value: Array<core_pb.MarkedTransaction>): void;
  addMarkedTransactions(value?: core_pb.MarkedTransaction, index?: number): core_pb.MarkedTransaction;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MarkedTxsReq.AsObject;
  static toObject(includeInstance: boolean, msg: MarkedTxsReq): MarkedTxsReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MarkedTxsReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MarkedTxsReq;
  static deserializeBinaryFromReader(message: MarkedTxsReq, reader: jspb.BinaryReader): MarkedTxsReq;
}

export namespace MarkedTxsReq {
  export type AsObject = {
    markedTransactionsList: Array<core_pb.MarkedTransaction.AsObject>,
    blockHash: string,
    blockchain: string,
...
export class QueuedMarkedTxsResponse extends jspb.Message {
  clearMarkedTransactionsList(): void;
  getMarkedTransactionsList(): Array<core_pb.MarkedTransaction>;
  setMarkedTransactionsList(value: Array<core_pb.MarkedTransaction>): void;
  addMarkedTransactions(value?: core_pb.MarkedTransaction, index?: number): core_pb.MarkedTransaction;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueuedMarkedTxsResponse.AsObject;
  static toObject(includeInstance: boolean, msg: QueuedMarkedTxsResponse): QueuedMarkedTxsResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueuedMarkedTxsResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueuedMarkedTxsResponse;
  static deserializeBinaryFromReader(message: QueuedMarkedTxsResponse, reader: jspb.BinaryReader): QueuedMarkedTxsResponse;
}

export namespace QueuedMarkedTxsResponse {
  export type AsObject = {
    markedTransactionsList: Array<core_pb.MarkedTransaction.AsObject>,
    blockHash: string,
  }
